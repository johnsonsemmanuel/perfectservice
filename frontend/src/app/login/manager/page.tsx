...
import { Loader2, Users, Car, ArrowLeft, BarChart3, ClipboardList, Eye, EyeOff } from 'lucide-react';
...
export default function ManagerLoginPage() {
    ...
    return (
        <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2">
            {/* Left Side - Black Branding (No Gradient) */}
            <div className="hidden lg:flex flex-col relative bg-black text-white overflow-hidden">
                <div className="relative z-10 flex flex-col justify-between h-full p-12">
                    ...
                    <div className="space-y-8 max-w-md">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold leading-tight">Manager Portal</h2>
                            <p className="text-gray-400 mt-3 leading-relaxed">
                                Oversee operations, manage your team, and track performance in real-time.
                            </p>
                        </div>
                ...
                <div className="w-full max-w-sm space-y-6">
                    ...
                    <div className="flex flex-col space-y-2">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-semibold text-red-900 uppercase tracking-wide">Manager Portal</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" disabled={isLoading} className="w-full bg-black hover:bg-gray-900 h-11 text-white">
                            Sign In
                        </Button>
                    </form>
